(function ($) {
    ...
    //$(".btnslide").click(function(b){b.preventDefault();alert('ops');newLocation=this.href;$("body").fadeOut(1000,a); window.location.href=newLocation;});
    ...
    $(window).on('load', function () {
        ...
        $('.selectpicker').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
            ...
            if (previousValue == "English") // open default language
            {
                window.location.href = "/";
            }
            else // open english version
            {
